...
const inputSchema = z.object({
  ...
  step: z
    .enum(["question_observation", "background_research", "hypothesis_formulation", "prediction", "testing_experimentation", "analysis", "conclusion"])
  ...
  targets_hypothesis_id: z
    .array(z.string())
    .exactOptional()
    .describe("Hypothesis ID(s) this step references (e.g., ['h1'])—required for prediction, testing, analysis"),
  hypothesis_update: z
    .object({
    ...
    .exactOptional()
    .describe("Create or update a hypothesis in hypothesis_formulation or analysis steps"),
